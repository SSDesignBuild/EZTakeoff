...
export const SERVICES: ServiceDefinition[] = [
  {
    ...
    defaults: {
      ...
      deckingMaterial: 'Trex Enhance Naturals - Foggy Wharf',
      breakerBoardCount: 0,
      breakerBoardMaterial: 'Trex Enhance Naturals - Foggy Wharf',
      breakerBoardMaterial2: 'match',
      breakerBoardMaterial3: 'match',
      pictureFrameCount: 1,
      pictureFrameMaterial: 'Trex Enhance Naturals - Foggy Wharf',
      pictureFrameMaterial2: 'match',
      pictureFrameMaterial3: 'match',
    ...
    fields: [
      ...
      { key: 'stairRailingRight', label: 'Railing on right side of stairs', type: 'boolean' },
      {
        ...
        options: [
          { label: 'None', value: '0' },
          { label: 'Single breaker board', value: '1' },
          { label: 'Double breaker board', value: '2' },
          { label: 'Triple breaker board', value: '3' },
        ],
      },
      { key: 'breakerBoardMaterial', label: 'Breaker board 1 style', type: 'select', options: DECK_BOARD_STYLE_WITH_MATCH_OPTIONS },
      { key: 'breakerBoardMaterial2', label: 'Breaker board 2 style', type: 'select', options: DECK_BOARD_STYLE_WITH_MATCH_OPTIONS },
      { key: 'breakerBoardMaterial3', label: 'Breaker board 3 style', type: 'select', options: DECK_BOARD_STYLE_WITH_MATCH_OPTIONS },
      {
        key: 'pictureFrameCount',
      ...
      { key: 'pictureFrameMaterial', label: 'Picture frame 1 style', type: 'select', options: DECK_BOARD_STYLE_WITH_MATCH_OPTIONS },
      { key: 'pictureFrameMaterial2', label: 'Picture frame 2 style', type: 'select', options: DECK_BOARD_STYLE_WITH_MATCH_OPTIONS },
      { key: 'pictureFrameMaterial3', label: 'Picture frame 3 style', type: 'select', options: DECK_BOARD_STYLE_WITH_MATCH_OPTIONS },
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { label: 'Wood 1.5x1.5 balusters', value: 'wood' },
          { label: 'Vinyl spindles', value: 'vinyl' },
          { label: 'Black round spindles', value: 'black-round' },
        ],
      },
...
gableSections: sharedGableDefaults,
  ...
  },
  {
    ...
    defaults: {
      ...
      beamStyle: 'atlas',
      postCount: 0,
      postAttachmentPoint: 'concrete',
      houseAttachmentMaterial: 'wood-fascia',
      jobNotes: '',
    },
    fields: [
      ...
      { key: 'postAttachmentPoint', label: 'Post bracket attachment point', type: 'select', options: [
        { label: 'Concrete slab/footer - 2.5 in Tapcon screws', value: 'concrete' },
        { label: 'Wooden deck/framing - wood lags', value: 'wood-deck' },
      ] },
      { key: 'houseAttachmentMaterial', label: 'House/C-channel attachment surface', type: 'select', options: [
        { label: 'Wood fascia', value: 'wood-fascia' },
        { label: 'Wood house siding', value: 'wood-siding' },
        { label: 'Brick / masonry house siding', value: 'brick-masonry' },
      ] },
...
gableSections: sharedGableDefaults,
...

  {
    slug: 'flat-pans',
    label: 'Flat pans',
    intro: 'Build a flat pan patio cover take-off with 12 in interlocking pans, 3 in header, 24 ft stock trim/structure, beams, posts, brackets, fasteners, gutter, fascia, downspouts, and NovaFlex.',
    highlights: ['12 in pan count', 'Beam span logic', 'Mid support when needed', '24 ft stock materials'],
    defaults: {
      width: 16,
      projection: 10,
      postHeight: 8,
      attachmentType: 'house',
      postType: '3x3',
      beamType: '3x3',
      panColor: 'white',
      framingColor: 'white',
    ...
    fields: [
      { key: 'width', label: 'Cover width (ft)', type: 'number', min: 1, step: 0.1 },
      { key: 'projection', label: 'Projection from attachment (ft)', type: 'number', min: 1, step: 0.1 },
      { key: 'postHeight', label: 'Post height (ft)', type: 'number', min: 1, step: 0.1 },
      { key: 'attachmentType', label: 'Attachment type', type: 'select', options: [
        { label: 'House / wall header', value: 'house' },
        { label: 'Fascia attachment', value: 'fascia' },
        { label: 'Freestanding header', value: 'freestanding' },
      ] },
      { key: 'beamType', label: 'Beam type', type: 'select', options: [
        { label: '3x3 beam - 10 ft post span', value: '3x3' },
        { label: 'Atlas beam - 16 ft post span', value: 'atlas' },
        { label: '4x4 beam - 16 ft post span', value: '4x4' },
        { label: 'I beam - 24 ft post span, requires 4x4 posts', value: 'i-beam' },
        { label: 'C beam - 24 ft post span, requires 4x4 posts', value: 'c-beam' },
      ] },
      { key: 'postType', label: 'Post type', type: 'select', options: [
        { label: '3x3 post', value: '3x3' },
        { label: '4x4 post', value: '4x4' },
      ] },
      { key: 'panColor', label: 'Flat pan color', type: 'select', options: [
        { label: 'White', value: 'white' },
        { label: 'Bronze', value: 'bronze' },
        { label: 'Wheat', value: 'wheat' },
        { label: 'Clay', value: 'clay' },
      ] },
      { key: 'framingColor', label: 'Framing / trim color', type: 'select', options: [
        { label: 'White', value: 'white' },
        { label: 'Bronze', value: 'bronze' },
        { label: 'Wheat', value: 'wheat' },
        { label: 'Clay', value: 'clay' },
    ...
    formulaNotes: [
      'Flat pans are 12 in wide interlocking panels ordered to the projection length with the standard 1 ft front overhang included in the cut length.',
      'Beam span limits: 3x3 = 10 ft between posts, Atlas and 4x4 = 16 ft, I-beam and C-beam = 24 ft and require 4x4 posts.',
      'Projection over 10 ft automatically adds a mid support beam with post count based on the selected beam span. Front beam, mid beam, header, side fascia, gutter, and posts use 24 ft stock ordering.',
    ],
  },
  {
    slug: 'sunrooms',
