...
export const SERVICES: ServiceDefinition[] = [
  {
    ...
    defaults: {
      ...
      deckingMaterial: 'Trex Enhance Naturals',
      breakerBoardCount: 0,
      breakerBoardMaterial: 'Trex Enhance Naturals',
      pictureFrameCount: 1,
      pictureFrameMaterial: 'Trex Enhance Naturals',
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'Trex Enhance Naturals', value: 'Trex Enhance Naturals' },
          { label: 'Trex Enhance Basics', value: 'Trex Enhance Basics' },
          { label: 'TimberTech Premier+ Collection', value: 'TimberTech Premier+ Collection' },
          { label: 'TimberTech Vintage Collection', value: 'TimberTech Vintage Collection' },
          { label: 'TimberTech Landmark Collection', value: 'TimberTech Landmark Collection' },
          { label: 'TimberTech Harvest Collection', value: 'TimberTech Harvest Collection' },
          { label: 'TimberTech Harvest+ Collection', value: 'TimberTech Harvest+ Collection' },
          { label: 'TimberTech Legacy Collection', value: 'TimberTech Legacy Collection' },
          { label: 'TimberTech Reserve Collection', value: 'TimberTech Reserve Collection' },
          { label: 'TimberTech Terrain+ Collection', value: 'TimberTech Terrain+ Collection' },
          { label: 'TimberTech Terrain Collection', value: 'TimberTech Terrain Collection' },
          { label: 'TimberTech Premier Collection', value: 'TimberTech Premier Collection' },
          { label: 'TimberTech Prime+ Collection', value: 'TimberTech Prime+ Collection' },
          { label: 'TimberTech Prime Collection', value: 'TimberTech Prime Collection' },
        ],
      },
      {
      ...
      {
        key: 'breakerBoardMaterial',
        label: 'Breaker board material',
        type: 'select',
        options: [
          { label: 'Match decking material', value: 'match' },
          { label: 'Pressure treated 5/4x6', value: 'Pressure treated 5/4x6' },
          { label: 'Trex Enhance Naturals', value: 'Trex Enhance Naturals' },
          { label: 'Trex Enhance Basics', value: 'Trex Enhance Basics' },
          { label: 'TimberTech Premier+ Collection', value: 'TimberTech Premier+ Collection' },
      ...
      {
        key: 'pictureFrameMaterial',
        label: 'Picture frame material',
        type: 'select',
        options: [
          { label: 'Match decking material', value: 'match' },
          { label: 'Pressure treated 5/4x6', value: 'Pressure treated 5/4x6' },
