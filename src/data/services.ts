...
export const SERVICES: ServiceDefinition[] = [
  {
    ...
    defaults: {
      ...
      stairRise: 0,
      stairCount: 0,
      stairRailingLeft: false,
      stairRailingRight: false,
      railingType: 'aluminum',
      spindleType: 'black-round',
      drinkRail: false,
      drinkRailMaterial: 'match',
      fasciaMaterial: 'match',
      perimeterRailingFt: 0,
      stairEdgeIndex: -1,
      stairOffset: 0,
      customBeamYs: JSON.stringify([]),
      manualRailingEdges: JSON.stringify([]),
      houseEdgeIndices: JSON.stringify([]),
      lowerHouseEdgeIndices: JSON.stringify([]),
      railCoverage: JSON.stringify([]),
    ...
    fields: [
      ...
      {
        key: 'deckingSurface',
        label: 'Deck surface layout/material',
        type: 'select',
        options: [
          { label: 'Deck boards', value: 'deck-boards' },
          { label: '4 ft x 8 ft x 3/4 in subfloor sheets', value: 'subfloor' },
        ],
      },
      {
        key: 'deckingType',
